...
from
        ...
        from
            ...
            select
                ...
                first_value(serp_search_params & 4503599627370496 > 0) over (partition by t.cookie_id, t.item_id, t.event_date order by t.event_datetime) as sdam_flg,
                first_value(serp_search_params & 2251799813685248 > 0) over (partition by t.cookie_id, t.item_id, t.event_date order by t.event_datetime) as str_flg,
                first_value(serp_search_params & 1125899906842624 > 0) over (partition by t.cookie_id, t.item_id, t.event_date order by t.event_datetime) as date_filtered_flg,
