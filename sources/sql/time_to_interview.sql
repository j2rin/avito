...
from (
    select
        ...
        date_diff('day', event_date_4066, event_date_invite) as time_to_invite_days,
        date_diff('day', event_date_4066, event_date_survey) as time_to_survey_days,
        date_diff('day', event_date_4066, chosen_interview_time) as time_to_interview,
        date_diff('day', item_activation_time, chosen_interview_time) as time_from_activation_to_interview,
        date_diff('day', event_date_4066, event_date_acceptance) as time_to_acceptance
