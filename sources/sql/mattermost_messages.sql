select
    ...
    from_big_endian_64(xxhash64(user_name)) as user_hash,
    message,
    regexp_like(lower(message), '\b(слой|слоя|слою|слоем|слое|слои|слоев|слоям|слоями|слоях)\b') as is_subject_layer
