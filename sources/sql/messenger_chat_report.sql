...
, chatbot as (
    ...
    where cast(start_flow_time as date) <= :last_date
        ...
        -- and start_flow_year between date_trunc('year', :first_date) - interval'1'year and date_trunc('year', :last_date) -- @trino
)
 select
 	chr.chat_id,
...
where true
    ...
    -- and min_event_year between date_trunc('year', :first_date) - interval'1'year and date_trunc('year', :last_date) -- @trino
