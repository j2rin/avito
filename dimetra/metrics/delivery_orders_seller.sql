...
select
    ...
    sum(case when is_paid = True and create_date > :ab_start_date then 1 end) as seller_delivery_items_paid_start_date,
    sum(case when is_performed = True then 1 end) as seller_delivery_items_performed,
    sum(case when is_performed = True and create_date > :ab_start_date then 1 end) as seller_delivery_items_performed_start_date,
...
select
    ...
    sum(case when seller_delivery_items_paid_start_date > 0 then 1 end) as seller_delivery_orders_paid_start_date,
    sum(case when seller_delivery_items_performed > 0 then 1 end) as seller_delivery_orders_performed,
    sum(case when seller_delivery_items_performed_start_date > 0 then 1 end) as seller_delivery_orders_performed_start_date,
