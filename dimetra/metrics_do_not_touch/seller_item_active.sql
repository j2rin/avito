...
select
    ...
    sum(case when description_word_count >= 5 and start_date = event_date then 1 end) as cnt_new_items_more_5_description_word,
    sum(case when start_date = event_date and photo_count >= 5 then 1 end) as cnt_new_items_more_5_photo,
    sum(case when has_short_video = True and is_active = True then 1 end) as item_video,
    sum(case when has_short_video = True and is_active = True and start_date = event_date then 1 end) as item_video_new,
...
select
    ...
    sum(case when item_video > 0 then 1 end) as user_item_video,
    sum(case when item_video_new > 0 then 1 end) as user_item_video_new,
