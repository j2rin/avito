...
select
    ...
    sum(case when eid = 3178 then event_count end) as app_version_update,
    ...
    sum(case when eid = 5557 then event_count end) as big_filter_choices,
    sum(case when eid = 6053 then event_count end) as blue_categories_click,
    sum(case when eid = 299 then event_count end) as call_phones,
    sum(case when eid = 6607 then event_count end) as callback_button_click,
    sum(case when eid = 6606 then event_count end) as callback_button_show,
    sum(case when eid = 6608 then event_count end) as callback_request_sent,
    ...
    sum(case when eid = 2848 then event_count end) as click_banner_main,
    sum(case when eid in (2745, 3183) then event_count end) as click_category_listbox,
    sum(case when eid = 2746 then event_count end) as click_more_categories,
    sum(case when eid = 5881 then event_count end) as click_onboarding,
    sum(case when eid = 6434 then event_count end) as click_schema_auto,
    sum(case when eid = 6832 then event_count end) as click_show_options_auto,
    sum(case when eid = 4404 then event_count end) as click_torg_btn,
    sum(case when eid = 5887 then event_count end) as close_onboarding,
    ...
    sum(case when eid = 6339 then event_count end) as feed_likes,
    ...
    sum(case when eid = 5752 then event_count end) as model_review_add_open_page,
    sum(case when eid = 5756 then event_count end) as model_reviews_added,
    ...
    sum(case when eid = 2847 then event_count end) as show_banner_main,
    sum(case when eid = 5879 then event_count end) as show_onboarding,
    ...
    sum(case when eid = 4298 then event_count end) as story_page_open,
...
select
    ...
    sum(case when allcategories_tap > 0 then 1 end) as user_allcategories_tap,
    sum(case when bargain_offer_price > 0 then 1 end) as user_bargain_offer_price,
    sum(case when big_filter_choices > 0 then 1 end) as user_big_filter_choices,
    sum(case when blue_categories_click > 0 then 1 end) as user_blue_categories_click,
    sum(case when callback_button_click > 0 then 1 end) as user_callback_button_click,
    sum(case when callback_button_show > 0 then 1 end) as user_callback_button_show,
    sum(case when callback_request_sent > 0 then 1 end) as user_callback_request_sent,
    sum(case when card_model > 0 then 1 end) as user_card_model,
    sum(case when click_banner_main > 0 then 1 end) as user_click_banner_main,
    sum(case when click_category_listbox > 0 then 1 end) as user_click_category_listbox,
    sum(case when click_more_categories > 0 then 1 end) as user_click_more_categories,
    sum(case when click_onboarding > 0 then 1 end) as user_click_onboarding,
    sum(case when click_schema_auto > 0 then 1 end) as user_click_schema_auto,
    sum(case when click_show_options_auto > 0 then 1 end) as user_click_show_options_auto,
    sum(case when click_torg_btn > 0 then 1 end) as user_click_torg_btn,
    sum(case when close_onboarding > 0 then 1 end) as user_close_onboarding,
    ...
    sum(case when model_review_add_open_page > 0 then 1 end) as user_model_review_add_open_page,
    ...
    sum(case when show_banner_main > 0 then 1 end) as user_show_banner_main,
    sum(case when show_onboarding > 0 then 1 end) as user_show_onboarding,
    ...
    sum(case when story_page_open > 0 then 1 end) as user_story_page_open,
...
select
    ...
    sum(case when feed_likes > 0 then 1 end) as user_feed_likes,
    ...
    sum(case when model_reviews_added > 0 then 1 end) as user_model_reviews_added,
